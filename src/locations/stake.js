...
const Stake = props => {
  ...
  const [stakingApr] = useXvaderAPR(
    'Day',
    defaults.xVaderAPRBasedNumberOfRecords,
    daysApr,
  )
    ...
    >
      <Flex flexDir={{ base: 'column', md: 'row' }}>
        ...
        >
          <Flex marginBottom={{ base: '1.2rem', md: '0' }}>
            <Container mb="23px" p="0">
              <>
                ...
                >
                  Stake your <i>APHRA</i> for <i>xAPHRA</i> and maximize your
                  yield. No&nbsp;Impermanent Loss.
                </Box>
                <Box as="p" fontSize={{ base: '0.9rem', md: '1rem' }}>
                  <b>xAPHRA</b> is fully composable that can interact with other
                  protocols. By staking <i>VADER</i>, you will be able to
                  participate in governance, get access to ecosystem airdrops,
                  obtain priority whitelist for new <i>VADER</i> ecosystem
                  projects and get paid from liquidity incentives - all by
                  holding the token.
                </Box>
                <Box as="p" fontSize={{ base: '0.9rem', md: '1rem' }}>
                  <i>xVADER</i> continuously yields compound, and when you
                  unstake your <i>xVADER</i>, you&lsquo;ll receive your original
                  deposited <b>VADER</b> plus any additional <i>VADER</i>{' '}
                  accrued.
                </Box>
              </>
            </Container>
              ...
              <>
                <Container p="0">
                  {xvdrExchangeRate?.global?.value > 0 && (
                    <ScaleFade initialScale={0.9} in={!xvdrExchangeRateLoading}>
                ...
                <Container p="0">
                  {Number(stakingApr) >= 0 && (
                    <ScaleFade initialScale={0.9} in={stakingApr >= 0}>
                      <Box textAlign={{ base: 'center', md: 'left' }}>
                        <Tooltip
                          hasArrow
          ...
          {token1balance.gt(0) && (
            <>
              <Fade in={token1balance.gt(0)}>
                <style>{stakedNow}</style>
                <Heading
                  as="h2"
                  size="sm"
                  textAlign={{ base: 'center', md: 'left' }}
          ...
          {token0balance.gt(0) && !token1balance.gt(0) && (
            <>
              <Fade in={token0balance.gt(0) && !token1balance.gt(0)}>
                <Heading
                  as="h2"
                  size="sm"
                  textAlign={{ base: 'center', md: 'left' }}
          ...
          {(token1balance.gt(0) || token0balance.gt(0)) && (
            <Flex flexDir="column" marginBottom="2.33rem">
              {token1balance.gt(0) && (
                <>
                  <Fade in={token1balance.gt(0)}>
                    <Flex mb="0.354rem">
        ...
        <Flex
          ...
          flexDir="column"
        >
          <Flex layerStyle="colorful" height="482.95px" marginTop="2.33rem">
