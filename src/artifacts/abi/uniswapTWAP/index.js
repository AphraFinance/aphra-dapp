module.exports = [
  {
    inputs: [
      { internalType: 'address', name: '_vader', type: 'address' },
      {
      ...
      { internalType: 'uint256', name: '_updatePeriod', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'lastMeasurement', type: 'uint256' },
      { internalType: 'uint256', name: 'updatePeriod', type: 'uint256' },
      { internalType: 'bool', name: 'isFirst', type: 'bool' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_maxPriceDiff', type: 'uint256' },
    ],
