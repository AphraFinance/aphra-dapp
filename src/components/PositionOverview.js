...
const PositionOverview = props => {
  ...
  const position = gql`
    query Items($account: String!, $id: String!) {
      nftitems(where: { id: $id, owner: $account }) {
        id
        owner {
          address
        }
