      ...
      >
        <Box {...linkWrapper}>
          <Link
            {...linkStyle}
            isExternal
            href="https://aphra.finance/whitepaper"
          >
        ...
        <Box {...linkWrapper}>
          <Link
            ...
            {...linkStyle}
            isExternal
            href={`https://uniswap.exchange/swap/${defaults.address.vader}`}
          >
            <svg
        ...
        <Box {...linkWrapper}>
          <Link {...linkStyle} isExternal href="https://docs.aphra.finance/">
            <FaBookOpen style={iconStyle} />
            Docs
          </Link>
        </Box>
      </Flex> */}
      <Flex {...container} gridGap={['1.3rem', '9rem']}>
        <Box {...linkWrapper}>
          <Link
            {...linkStyle}
            isExternal
            href="https://discord.com/invite/aphrafinance"
          >
        ...
        <Box {...linkWrapper}>
          <Link
            {...linkStyle}
            isExternal
            href="https://github.com/aphrafinance/"
          >
